    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo', models.CharField(choices=[('Notebook', 'Notebook'), ('Smartphone', 'Smartphone'), ('TV Smart', 'TV Smart')], default='Smartphone', max_length=15)),
                ('armazenamento', models.FloatField()),
                ('largura', models.IntegerField()),
                ('altura', models.IntegerField()),
                ('tensao', models.IntegerField()),
                ('conectividade', models.CharField(max_length=120)),
            ],
        ),
        migrations.CreateModel(
            name='Usuario',
